...
const SvgListAlphabetUppercaseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={1.5}
      clipPath="url(#ListAlphabetUppercase_svg__a)"
    >
      <path
        strokeLinecap="round"
    ...
    <defs>
      <clipPath id="ListAlphabetUppercase_svg__a">
        <path fill="#fff" d="M0 0h32v32H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgListAlphabetUppercaseIcon;
