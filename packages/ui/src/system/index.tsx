...
import * as S from "@xstyled/emotion";
...
export const filterSystemProps = (prop: string): boolean =>
  !system.meta.props.includes(prop);
export const shouldForwardProp: any = (prop, defaultValidatorFn) =>
...
export type MergeProps<ComponentProps, Props, WuiProps> = RightJoinProps<
  ComponentProps,
  Props
> &
