        ...
        <Container width={70} bg="">
          <Flex sx={{ py: 5, flex: 1, flexDirection: `row` }}>
            <Flex sx={{ flexDirection: `column` }}>
              ...
              <Text as="p" sx={{ color: `#767676` }}>© wraft 2022</Text>
            </Flex>
            ...
            <Box sx={{ ml: `auto` }}>
              <Flex sx={{ flexDirection: `column`, alignItems: `flex-end` }}>
                ...
                <Flex sx={{ gap: `20px` }}>
                  <Text as="p" sx={{ color: `gray.6`, fontWeight: `500` }}>Privacy</Text>
                  <Text as="p" sx={{ color: `gray.6`, fontWeight: `500` }}>Contact</Text>
                </Flex>
