...
//         let buttonState:any = 'default'
//         if(attrs) {
//           buttonState = getButtonState(actions[name].isActive(attrs), inverse);
//         }
...
//   return (
//     <IconButton onClick={onClick} state={state} disabled={disabled} index={index} translate={0}>
