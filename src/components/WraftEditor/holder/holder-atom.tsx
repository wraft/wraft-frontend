...
export class HolderAtomExtension extends NodeExtension<HolderAtomOptions> {
    ...
    createNodeSpec(extra: ApplySchemaAttributes, override: NodeSpecOverride): NodeExtensionSpec {
        ...
        return {
            ...
            toDOM: (node) => {
                ...
                return [matcher?.mentionTag ?? this.options.mentionTag, attrs, value];
            },
        };
    }
     ...
     */
    @command()
    createHolderAtom(details: CreateHolderAtom, attrs: HolderAtomNodeAttributes): CommandFunction {
        ...
        invariant(validNameExists, {
            ...
            message: `Invalid name '${name}' provided when creating a mention. Please ensure you only use names that were configured on the matchers when creating the \`HolderAtomExtension\`.`,
        });
