...
export interface UseHolderAtomReturn<
  Data extends HolderAtomNodeAttributes = HolderAtomNodeAttributes,
> extends UseMenuNavigationReturn<Data> {
  state: HolderAtomState<Data> | null;
}
...
>(props: UseHolderAtomProps<Data>): UseHolderAtomReturn<Data> {
   ...
   */
  const onChange: HolderAtomChangeHandler = useCallback(
    (props, command) => {
...
export interface UseHolderAtomProps<
  Data extends HolderAtomNodeAttributes = HolderAtomNodeAttributes,
...
export type { HolderAtomNodeAttributes };
